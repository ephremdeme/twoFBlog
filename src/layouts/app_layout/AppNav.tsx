...
export default function AppNav(props: Props) {
	...
	React.useEffect(() => {
		firebase.getInstance().auth.onAuthStateChanged((user: any): any => {
			if (user) {
	...
	const drawer_guest = (
		<div>
			...
			<List>
				...
				<ListItem button className={classes.listItems} component={Link} to={`/editor`}>
					<ListItemIcon>
						<MailIcon />
					</ListItemIcon>
					<ListItemText className={classes.listItemText} primary="Editor" />
				</ListItem>
				<ListItem button className={classes.listItems} component={Link} to={`/product`}>
					<ListItemIcon>
						<MailIcon />
					</ListItemIcon>
					<ListItemText className={classes.listItemText} primary="ProductsX" />
				</ListItem>
			</List>
		</div>
	);
